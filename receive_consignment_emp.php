...
<script src="js/receive_consignment.js"></script>
...
<div class="container">
  <form class="form-inline">
    <div class="form-group">
      <input type="text" class="form-control" id="con_id" placeholder="Enter Consignment Id" name="con_id" required>
    </div>
    
    <div class="form-group">
      <button type="submit" id="receive_btn" class="btn btn-success">Receive</button>
      <button class="btn btn-primary"><a href="view_consignment_emp.php" style="text-decoration: none; color: white;">Go Back</a></button>
    </div>
